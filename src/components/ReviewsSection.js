const ReviewsSection = () => {
  return (
    <section className=" bg-blue-700 h-fit ">
        <div className="text-center">
          <h1 className="text-4xl text-white">Reviews</h1>
        </div>
      ...
      >
        <div className="max-w-7xl items-end justify-between sm:flex sm:pr-6 lg:pr-8">
          <h2 className="max-w-xl text-4xl font-bold tracking-tight sm:text-3xl text-white">
            Read trusted reviews from our customers
          </h2>

          <div className="mt-8 flex lg:mt-0">
            <button
              className="prev-button rounded-full border border-current p-3 text-pink-600 transition-colors focus:bg-pink-600 focus:text-white focus:outline-none"
            >
            ...
            <button
              className="next-button ml-3 rounded-full border border-current p-3 text-pink-600 focus:bg-pink-600 focus:text-white focus:outline-none"
            >
